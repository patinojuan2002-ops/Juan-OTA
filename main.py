...
# =========================
# ESPERAR QUE EL CHIP WIFI ARRANQUE
# =========================
time.sleep(2)
...
# OTA - ACTUALIZACIÓN
# =========================
firmware_url = "https://github.com/patinojuan2002-ops/Juan-OTA/"
ota_updater = OTAUpdater(WIFI_CONFIG.SSID, WIFI_CONFIG.PASSWORD, firmware_url, "main.py")
